...
The reason we want to create a system user instead of using a regular user or root is to enhance security and keep the functions isolated from regular user activities. It decreases the risk of accidental or malicious system wide chages.
